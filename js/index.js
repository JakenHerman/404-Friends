...
function resetFormPuppy(withPuppies) {
  var message = "Sorry that command is not recognized."
  var input = $('.404-input');

  if (withPuppies) {
    $('.puppies').removeClass('puppies');
    message = "Huzzzzzah Puppehs!"
  }
...
function showPuppies() {
  $('.terminal').append("<div class='kittens'>" + "PUPPIES INCOMING!!!!");
  var lines = $('.puppies p');
...
function showKittens() {
  $('.terminal').append("<div class='kittens'>" + "KITTENS INCOMING!!!!");
